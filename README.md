...
for [test project](https://crm.saritasa.com/projects/general.aspx?ProjectID=???) project
...
## API Documentation
https://apidocs.saritasa.io/?url=test-project/develop/test-project-latest.yaml

## Goolge Drive
TODO: setup link

## SonarQube
https://sonarqube.saritasa.com/dashboard?id=test-project-backend
...
git clone ssh://gitblit.saritasa.com/test-project/backend.git
cd backend
...
docker ps
```
There should be: test-project-web, test-project-db, test-project-redis
...
(*shortcut for ```docker inspect test-project-web | grep IPAddress```*) -
